...
class ApplicationTest {
  ...
  void testNoArgsConstructorAndSetters() {
    ...
    assertThat(app.getLoanTypeId()).isEqualTo(3L);
  }

  @Test
  void testAllArgsConstructor() {
    Application app = new Application(10L, 10000L, 24, "user@mail.com", 1, 2L);
    ...
    assertThat(app.getLoanTypeId()).isEqualTo(2L);
  }
  ...
  void testFieldEnumLabels() {
    ...
    assertThat(Application.Field.LOAN_TYPE_ID.toString()).isEqualTo("LOAN TYPE ID");
  }
}
